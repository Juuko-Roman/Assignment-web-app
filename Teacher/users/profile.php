...
$query=mysqli_query($bd, "update teacher set username='$userName',phoneNo='$phoneNo' where username='".$_SESSION['login']."'");
if($query)
{
$successmsg="Profile upddated Successfully !!";
}
else
{
...
<html lang="en">
     ...
     <?php include("includes/header.php");?>
      ...
      <section id="main-content">
          <section class="wrapper">
            <h3 style="text-align: center; color:red;"> <b>PROFILE INFO</b></h3>
 ...
 <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
                      ...
                      <?php }?>
 <?php $query=mysqli_query($bd, "select * from teacher where username='".$_SESSION['login']."'");
 while($row=mysqli_fetch_array($query)) 
 {
 ?>                     

  <h4 class="mb"><i class="fa fa-user"></i>&nbsp;&nbsp;<?php echo htmlentities($row['lastName'])." ".htmlentities($row['firstName']);?>'s Profile</h4>
...
<button type="submit" name="submit" class="btn btn-primary">Click to save made changes</button>
</div>
</div>
