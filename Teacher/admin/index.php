...
<head>
	...
	<title>KDLsys | Admin login</title>
...
<body>
		...
		<div class="navbar-inner" style="background-color: grey;">
			<div class="container">
				<a class="btn btn-navbar" data-toggle="collapse" data-target=".navbar-inverse-collapse">
			  	...
			  	<a class="brand" href="#">
			  		<span style="color:white">KDLsys | Admin</span>
			  	</a>
	...
	<div class="footer" style="margin-left: 45%">
		<div class="container">
			...
			<b class="copyright">&copy; 2022 KDLsys </b> All rights reserved.
		</div>
	</div>
