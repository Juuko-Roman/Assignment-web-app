...
{
$sql=mysqli_query($bd, "SELECT password FROM  admin where password='".$_POST['password']."' && username='".$_SESSION['alogin']."'");
$num=mysqli_fetch_array($sql);
if($num>0)
{
 $con=mysqli_query($bd, "update admin set password='".$_POST['newpassword']."', updationDate='$currentTime' where username='".$_SESSION['alogin']."'");
					...
					<div class="content">
						...
						<div class="module">
							<div class="module-head">
								<h3 style="text-align: center;">Admin Change Password</h3>
							</div>
