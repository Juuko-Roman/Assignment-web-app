...
<?php $query=mysqli_query($bd, "select * from teacher");
$cnt=1;
...
?>									
										<tr>
											...
											<td><a href="javascript:void(0);" onClick="popUpWindow('http://localhost/Teacher/admin/userprofile.php?uid=<?php echo htmlentities($row['teacher_id']);?>');" title="View details">
